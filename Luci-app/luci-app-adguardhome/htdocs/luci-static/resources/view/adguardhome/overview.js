...
var style = [
	...
	'.agh-alert-head{display:inline-flex;align-items:center;gap:0;max-width:100%;min-height:30px;padding:6px 12px;border-radius:999px;background:rgba(255,255,255,.11);border:1px solid rgba(255,255,255,.16);box-shadow:none;cursor:help;user-select:none;color:var(--agh-compat-text);backdrop-filter:saturate(140%) blur(2px)}',
	'.agh-alert-head:hover,.agh-alert-head:focus-within{background:rgba(255,255,255,.17);border-color:rgba(255,255,255,.24)}',
	'.agh-alert-title{font-size:12px;font-weight:700;line-height:1.4;color:var(--agh-compat-text);white-space:nowrap}',
