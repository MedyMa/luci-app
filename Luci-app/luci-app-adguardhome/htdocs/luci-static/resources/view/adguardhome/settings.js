...
var style = [
	...
	'.agh-settings .cbi-checkbox label,.agh-settings .cbi-radio label{border:1px solid var(--agh-checkbox-border)!important;background:var(--agh-checkbox-bg)!important;box-shadow:none!important}.agh-settings .cbi-checkbox input:checked + label,.agh-settings .cbi-radio input:checked + label{background:var(--agh-checkbox-active-bg)!important;border-color:var(--agh-checkbox-active-border)!important}.agh-settings .cbi-checkbox input:focus + label,.agh-settings .cbi-radio input:focus + label{box-shadow:0 0 0 3px rgba(104,146,214,.18)!important}',
