...
var style = [
	'.agh-settings{display:grid;gap:18px;color:var(--agh-text,var(--text-color-high,#203042));--agh-text:var(--text-color-high,#203042);--agh-text-high:var(--text-color-high,#17373c);--agh-text-muted:var(--text-color-medium,#667084);--agh-text-soft:#60708a;--agh-border:rgba(76,108,157,.14);--agh-border-soft:rgba(76,108,157,.08);--agh-card-bg:rgba(249,252,255,.98);--agh-card-grad:linear-gradient(180deg,rgba(255,255,255,.99) 0%,rgba(240,246,255,.99) 100%);--agh-surface-bg:rgba(232,240,251,.92);--agh-chip-bg:rgba(255,255,255,.97);--agh-chip-border:rgba(76,108,157,.14);--agh-chip-shadow:0 8px 24px rgba(25,50,87,.08);--agh-status-bg:rgba(232,240,251,.94);--agh-input-bg:rgba(255,255,255,.97);--agh-input-border:rgba(76,108,157,.18);--agh-tabmenu-bg:rgba(232,240,251,.94);--agh-tab-text:#5e6f88;--agh-tab-active-text:var(--agh-text-high,#17373c);--agh-tab-active-bg:rgba(255,255,255,.98);--agh-badge-bg:rgba(61,103,159,.12);--agh-badge-fg:#315d9a;--agh-button-shadow:none;--agh-inline-btn-bg:rgba(61,103,159,.10);--agh-inline-btn-bg-hover:rgba(61,103,159,.16);--agh-inline-btn-border:rgba(61,103,159,.20);--agh-inline-btn-fg:#315d9a;--agh-hero-bg:linear-gradient(135deg,#294a7a 0%,#3d679f 54%,#6f93cc 100%);--agh-hero-shadow:0 18px 38px rgba(25,50,87,.16)}',
	'.agh-settings.agh-dark,body.dark .agh-settings,html.dark .agh-settings,body.mode-dark .agh-settings,body.argon-dark .agh-settings,html[data-theme="dark"] .agh-settings,body[data-theme="dark"] .agh-settings{--agh-text:#e7eef7;--agh-text-high:#eef5fd;--agh-text-muted:#a8b7c7;--agh-text-soft:#b8c7d6;--agh-border:rgba(124,147,186,.24);--agh-border-soft:rgba(124,147,186,.16);--agh-card-bg:rgba(16,24,38,.96);--agh-card-grad:linear-gradient(180deg,rgba(18,28,44,.96) 0%,rgba(10,17,29,.98) 100%);--agh-surface-bg:rgba(9,15,27,.84);--agh-chip-bg:rgba(17,26,40,.94);--agh-chip-border:rgba(124,147,186,.18);--agh-chip-shadow:0 10px 26px rgba(0,0,0,.24);--agh-status-bg:rgba(9,15,27,.88);--agh-input-bg:rgba(8,14,24,.94);--agh-input-border:rgba(124,147,186,.22);--agh-tabmenu-bg:rgba(9,15,27,.88);--agh-tab-text:#a8b7c7;--agh-tab-active-text:#eef5fd;--agh-tab-active-bg:rgba(23,35,52,.96);--agh-badge-bg:rgba(104,146,214,.18);--agh-badge-fg:#a9c6f3;--agh-inline-btn-bg:rgba(104,146,214,.16);--agh-inline-btn-bg-hover:rgba(104,146,214,.24);--agh-inline-btn-border:rgba(104,146,214,.28);--agh-inline-btn-fg:#a9c6f3;--agh-hero-bg:linear-gradient(135deg,#0c1424 0%,#15253d 54%,#234267 100%);--agh-hero-shadow:0 20px 40px rgba(0,0,0,.28)}',
	...
	'.agh-action-badge{display:inline-flex;align-items:center;width:max-content;padding:5px 10px;border-radius:999px;background:var(--agh-action-badge-bg,var(--agh-badge-bg));color:var(--agh-action-badge-fg,var(--agh-badge-fg));font-size:11px;font-weight:700;letter-spacing:.04em;text-transform:uppercase}',
	'.agh-action h3{all:unset;display:block;font-size:17px;line-height:1.35;font-weight:700;color:var(--agh-text-high)}',
	'.agh-action p{margin:0;color:var(--agh-text-soft);line-height:1.7;font-size:13px}',
	'.agh-action textarea{width:100%;min-height:150px;border-radius:14px;border-color:var(--agh-input-border);background:var(--agh-input-bg);color:var(--agh-text-high);-webkit-text-fill-color:var(--agh-text-high)!important;text-shadow:none!important;caret-color:var(--agh-text-high);font-family:monospace;font-size:12px;box-sizing:border-box}',
	...
	'.agh-status{margin-top:12px;padding:10px 12px;border-radius:14px;background:var(--agh-status-bg);color:var(--agh-text-soft);font-size:12px;line-height:1.6}',
	'.agh-settings .cbi-map{border-radius:22px;border:1px solid var(--agh-border);box-shadow:0 12px 30px rgba(17,48,54,.08);overflow:visible;background:var(--agh-card-bg)}',
	...
	'.agh-settings .cbi-tabmenu{padding:14px 16px 0;border-bottom:1px solid var(--agh-border-soft);background:var(--agh-tabmenu-bg)}.agh-settings .cbi-tab,.agh-settings .cbi-tab-disabled{border-radius:12px 12px 0 0;background:transparent}.agh-settings .cbi-tab>a,.agh-settings .cbi-tab-disabled>a{color:var(--agh-tab-text)!important;background:transparent!important;text-shadow:none!important}.agh-settings .cbi-tab-active,.agh-settings .cbi-tab-active>a{background:var(--agh-tab-active-bg)!important;color:var(--agh-tab-active-text)!important}.agh-settings .cbi-tabcontainer{padding-top:4px}',
	'.agh-settings .cbi-value{padding:14px 20px;border-top:1px solid var(--agh-border-soft)}.agh-settings .cbi-value-title{font-weight:650;color:var(--agh-text-high)}.agh-settings .cbi-value-description{max-width:58rem;color:var(--agh-text-muted);line-height:1.55}',
	'.agh-settings input[type="text"],.agh-settings input[type="password"],.agh-settings textarea,.agh-settings select{border-radius:12px;border-color:var(--agh-input-border);background:var(--agh-input-bg);color:var(--agh-text-high);-webkit-text-fill-color:var(--agh-text-high)!important;text-shadow:none!important;caret-color:var(--agh-text-high);box-shadow:none}',
